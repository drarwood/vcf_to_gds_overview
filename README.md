...
Running the `get_vcf_file_list_by_chr_and_split.sh` bash script in this repo will produce all the relevant input files for chromosome 17 (`chr17_vcf_list_[1:100]`) (as well as all other chromosomes for the 60,648 VCFs currently available).
