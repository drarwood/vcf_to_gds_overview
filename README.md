...
##### Submitting the jobs
Once you have a set of 100 files listing the VCFs, you can run the [`vcf_trimmer`](https://github.com/drarwood/vcf_trimmer) with each of the files generated above. 
